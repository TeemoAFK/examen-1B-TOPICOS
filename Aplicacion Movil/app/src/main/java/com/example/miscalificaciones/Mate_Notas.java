...
public class Mate_Notas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mate__notas);
        ...
        db.collection("Notas").document("Matematica").addSnapshotListener(new EventListener<DocumentSnapshot>() {
            @Override
